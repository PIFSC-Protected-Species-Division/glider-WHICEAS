...
configFiles = {
fullfile(missionPaths{1}, 'agate_config_sg274_20260128_WHICEAS_pam-ww.cnf');
fullfile(missionPaths{2}, 'agate_config_sg607_20260128_WHICEAS_pam-ww.cnf');
fullfile(missionPaths{3}, 'agate_config_sg639_20260211_WHICEAS_pam-ww.cnf');
fullfile(missionPaths{4}, 'agate_config_sg679_20260205_WHICEAS_pam-ww.cnf')
};
...
ppStruct.sg274 = workflow_downloadScript_sg274_20260128_WHICEAS(configFiles{1}, 0);
ppStruct.sg607 = workflow_downloadScript_sg607_20260128_WHICEAS(configFiles{2}, 0); % don't preload because of comms issues
ppStruct.sg639 = workflow_downloadScript_sg639_20260211_WHICEAS(configFiles(3), 0);
ppStruct.sg679 = workflow_downloadScript_sg679_20260205_WHICEAS(configFiles(4), 0);
