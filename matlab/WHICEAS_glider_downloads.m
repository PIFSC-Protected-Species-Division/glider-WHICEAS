...
figure(2027); % make recovery planner the current fiture
exportgraphics(gcf, fullfile('A:\My Drive\Glider Projects\2026 WHICEAS Gliders', ...
    'recovery_planner.png'), 'Resolution', 600);
exportgraphics(gcf, fullfile(path_repo, 'outputs', ...
    'recovery_planner.png'), 'Resolution', 600);
